...
(eg. [`Cufflinks`](http://cole-trapnell-lab.github.io/cufflinks/),
[`RSEM`](http://deweylab.github.io/RSEM/)) incorporated 
...
Example of a __CPM__ function in `R`:
...
problematically violated. Therefore, will not apply them here. 
...
`calculateCPM()` function.  For __scran__
