...
```{r, echo=FALSE}
library(knitr)
opts_chunk$set(out.width='90%', fig.align = 'center', warning=FALSE, message=FALSE)
```
...
The data consists of `r length(unique(anno$individual))` individuals 
and `r length(unique(anno$replicate))` replicates and therefore has 
`r length(unique(anno$batch))` batches in total.
